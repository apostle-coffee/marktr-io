...
export default function CollectionColorModal({ open, id, currentColor, onClose, onSaved }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="font-semibold text-lg mb-4">Choose Collection Colour</h2>
