...
export function CollectionCard({
  ...
  const formattedDate = (collection.lastUpdated || new Date().toISOString()) &&
    new Date(collection.lastUpdated || new Date().toISOString()).toLocaleDateString("en-US", {
      year: "numeric",
      month: "short",
      day: "numeric",
    });
            ...
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuItem
                  ...
                  onSelect={(e) => {
                    stop(e);
                    onChangeColor?.(collection.id, bgColor);
                  }}
                >
                  <span
                    className="w-4 h-4 mr-2 inline-block rounded-full border border-black"
                    style={{ backgroundColor: bgColor }}
                  />
                  Change Colour
                </DropdownMenuItem>
